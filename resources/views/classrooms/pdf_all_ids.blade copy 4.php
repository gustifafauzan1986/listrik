...
<head>
    ...
    <style>
        ...
        /* Kotak Kartu */
        .card-container {
            width: 9cm;  /* Ukuran spesifik sesuai request */
            height: 4cm; /* Ukuran spesifik sesuai request */
        ...
        .card-bg::after {
            ...
            left: 0;
            width: 100%;
            height: 5px; /* Sedikit diperkecil karena tinggi kartu berkurang */
        ...
        .left-col {
            width: 35%; /* Sedikit diperlebar untuk QR */
            text-align: center;
        ...
        /* Tipografi */
        .school-name {
            font-size: 6pt; /* Dikecilkan sedikit */
            font-weight: bold;
            color: #666;
        ...
        .card-title {
            font-size: 10pt; /* Dikecilkan sedikit */
            font-weight: 900;
            color: #1a73e8;
            margin-bottom: 6px;
            text-transform: uppercase;
        ...
        /* Gambar QR */
        .qr-img {
            width: 2.2cm; /* Disesuaikan dengan tinggi 4cm */
            height: 2.2cm;
            padding: 2px;
