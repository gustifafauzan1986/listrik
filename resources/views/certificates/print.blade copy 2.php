...
<head>
    ...
    <style>
        ...
        .content {
            ...
            z-index: 10;
            text-align: center;
            padding-top: 40px; /* Reduced top padding to fit more signatures */
            color: #333;
        }
        ...
        .footer {
            ...
            padding: 0 40px;
            font-family: 'Roboto', sans-serif;
            font-size: 9pt; /* Font agak kecil agar muat 4 orang */
        }

        .signature {
            text-align: center;
            width: 22%; /* Bagi 4 kolom */
        }
        ...
        .signature-line {
            ...
            height: 50px; /* Ruang untuk tanda tangan */
        }
