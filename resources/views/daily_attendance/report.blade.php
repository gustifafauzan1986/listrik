                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="mr-2 col">
                                    ...
                                    <div class="mb-0 text-gray-800 h5 font-weight-bold">{{ $summary['telat'] }}</div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center fw-bold text-success">
                                        {{ $row->time_in ? \Carbon\Carbon::parse($row->time_in)->format('H:i') : '-' }}
                                    </td>

                                    <!-- Jam Pulang -->
                                    <td class="text-center fw-bold text-primary">
                                        {{ $row->time_out ? \Carbon\Carbon::parse($row->time_out)->format('H:i') : '-' }}
                                    </td>
