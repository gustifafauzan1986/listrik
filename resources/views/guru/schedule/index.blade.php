        ...
        <div class="container py-4">
            ...
            <div class="mb-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 text-muted small">Kelola jadwal pelajaran dan pantau absensi harian.</p>
                </div>
                <a href="{{ route('schedule.create') }}" class="shadow-sm btn btn-primary">
            ...
            <ul class="mb-4 nav nav-tabs" id="scheduleTabs" role="tablist">
            ...
            <div class="tab-content" id="scheduleTabsContent">
                ...
                <div class="tab-pane fade show active" id="list-view" role="tabpanel">
                    <div class="row">
                            ...
                            <div class="mb-4 col-md-6 col-lg-4 card-column position-relative">
                                <div class="card shadow-sm h-100 border-start border-4 {{ $cardBorder }} {{ $activeClass }} hover-card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="mb-2 card-title fw-bold text-dark text-truncate" title="{{ $schedule->subject->name ?? 'Mapel Dihapus' }}">
                                            {{ $schedule->subject->name ?? 'Mapel Dihapus' }}
                                        </h5>

                                        <div class="mb-3">
                                            <span class="px-2 py-1 border rounded d-inline-flex align-items-center bg-light text-primary border-primary-subtle fw-bold">
                                        ...
                                        <div class="mt-3 d-flex justify-content-between align-items-end">
                                            <div class="mb-1 small text-muted" title="Jumlah siswa yang sudah absen hari ini">
                        ...
                        @empty
                            <div class="col-12">
                                <div class="py-5 text-center border alert alert-light">
                                    ...
                                    <p class="mb-3 text-muted">Silakan buat jadwal untuk mulai mengabsen.</p>
