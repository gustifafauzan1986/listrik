        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventContent: function(arg) {
                    ...
                    content.innerHTML = `
                        <div class="fc-event-time" style="font-size:0.85rem; opacity:0.9;">${timeText}</div>
                        <div class="fc-event-title" style="font-weight:bold; font-size:0.65rem; margin-bottom:4px; line-height:1.1;">${subject}</div>
