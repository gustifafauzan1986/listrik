                                    ...
                                    <div class="d-flex gap-1">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="{{ url('/attendance/manual/' . $schedule->id) }}">
                                                        <i class="fas fa-clipboard-list me-2 text-secondary"></i> Input Manual
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{ url('/attendane/scan/' . $schedule->id) }}">
                                                        <i class="fas fa-qrcode me-2 text-dark"></i> Scan QR Code
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{ url('/attendance/face/' . $schedule->id) }}">
