...
<x-app-layout>
                        ...
                        <form action="{{ route('admin.prayer.settings.update') }}" method="POST">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-6">
                                    ...
                                    <!-- Hapus readonly dan tambahkan oninput -->
                                    <input type="text" id="lat" name="masjid_lat" class="form-control" value="{{ $lat }}" required oninput="manualInputUpdate()">
                                    <small class="text-muted">Koordinat update otomatis saat peta digeser, atau ketik manual.</small>
                                </div>
                                <div class="col-md-6">
    ...
    <script>
        // Variabel Global agar bisa diakses fungsi search dan manual update
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            setTimeout(() => {
                ...
                // Expose manualInputUpdate to global scope (Fungsi Baru)
                window.manualInputUpdate = function() {
                    ...
                    if (!isNaN(lat) && !isNaN(lng)) {
                        ...
                        // Update posisi marker dan circle
        ...
        // Fungsi Update Posisi Marker & Form (Dipanggil saat drag/click/search)
        ...
        // Fungsi Update Input Text (Dipanggil saat marker berubah posisi)
