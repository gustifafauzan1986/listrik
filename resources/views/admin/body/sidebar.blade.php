			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
                        ...
                        <li> <a href="{{route('programs.index')}}"><i class='bx bx-minus-front'></i>Program Keahlian</a></li>
				...
				<li>
					...
					<ul>
						...
						<li> <a href="{{route('report.surat_tugas_all')}}" target="_blank"><i class='bx bx-id-card'></i>Surat Tugas</a></li>
