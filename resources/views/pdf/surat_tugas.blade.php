...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-size: 12pt;
            line-height: 1.15; /* Spasi baris rapat seperti surat resmi */
        }
        ...
        .school-info h2 { margin: 0; font-size: 14pt; font-weight: normal; } /* PEMERINTAH PROVINSI... */
        .school-info h1 { margin: 0; font-size: 16pt; font-weight: bold; }   /* SMK NEGERI... */
        ...
        .ttd-box { float: right; width: 300px; text-align: left; } /* Rata kiri di dalam box kanan */
    </style>
</head>
<body>
    ...
    <table class="header-table">
        <tr>
            ...
            <td width="70%" class="school-info">
                ...
                <p>{{ $school['school_address'] ?? 'Jalan Iskandar Teja Sukmana - Padang Gamuak, Bukittinggi-26117' }}</p>
    ...
    <table class="bio-table">
        ...
        <tr>
            <td class="bio-label">Pangkat/Golongan</td>
            <td class="bio-sep">:</td>
    ...
    <table class="schedule-table">
        ...
        <tbody>
            ...
            @php
                // Mapping hari bahasa inggris ke indo
                $hariIndo = [
                    'Monday' => 'Senin', 'Tuesday' => 'Selasa', 'Wednesday' => 'Rabu',
                    'Thursday' => 'Kamis', 'Friday' => 'Jumat', 'Saturday' => 'Sabtu', 'Sunday' => 'Minggu'
                ];
                $hari = $hariIndo[$sched->day] ?? $sched->day;

                // Hitung jam ke (dummy logic jika tidak ada di DB, bisa disesuaikan)
            ...
            <tr>
                ...
                <td>{{ $sched->calculated_jp ?? '-' }}</td>
                <td>{{ $sched->room ?? '-' }}</td> {{-- Pastikan ada kolom room di DB, atau ganti '-' --}}
                <td>{{ $sched->subject->code ?? 'PBM' }}</td>
            </tr>
            @endforeach

            <!-- BARIS TUGAS TAMBAHAN (JIKA ADA) -->
            ...
            <tr>
                <td>{{ $no++ }}</td>
                <td></td>
                <td colspan="2" class="col-left">{{ $teacher->tugas_tambahan }}</td>
                <td>12</td> {{-- Biasanya 12 jam untuk Kaprog/Kabeng --}}
                <td></td>
                <td></td>
            </tr>
