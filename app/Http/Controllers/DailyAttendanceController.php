...
class DailyAttendanceController extends Controller
{
    ...
    public function report(Request $request)
    {
        ...
        return view('daily_attendance.report', compact('attendances', 'students', 'summary', 'classrooms'));
    }
    ...
    public function printAbsensi(Request $request)
    {
        ...
        // GENERATE PDF
        $pdf = Pdf::loadView('daily_attendance.pdf_view', compact(
            'attendances',
            'labelPeriode',
            'startDate',
            'endDate',
    ...
    public function printStudentAbsensi($id)
    {
        ...
        $pdf = Pdf::loadView('daily_attendance.student_history', compact(
            'student',
            'attendances',
            'summary',
            'startDate',
